...
# Funcion aux para modificar firstName
...
# Función de prueba positiva reutilizable
...
# Función de prueba negativa (simbolo o longitud)
...
# Función de prueba negativa (falta firstName)
...
# Test 2. New user with limit characters (15)
def test_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("Aaaaaaaaaaaaaaa")

#Test 3 No. de caracteres menor a la permitida
